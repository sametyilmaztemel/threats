...
type EntityKind = 'actor' | 'technique' | 'cve' | 'ioc' | 'sector' | 'source';
...
export default function EntityBadge({ kind, label, count, href }: EntityBadgeProps) {
  ...
  const baseClasses =
    'inline-flex items-center gap-1 px-1.5 py-[1px] text-[10px] font-mono uppercase tracking-widest2 border hover:bg-fg hover:text-bg transition-colors';
