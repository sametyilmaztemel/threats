  ...
  return (
    <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-6 md:py-12">
      <div className="mb-6 md:mb-8">
        ...
        <p className="text-xs text-dim mt-2 break-words">{nodes.length} nodes · {edges.length} edges</p>
      </div>
      <div className="border border-line p-4 md:p-8 min-h-[400px] md:min-h-[600px] flex items-center justify-center">
        <div className="text-center text-dim text-sm">
          ...
          <div className="text-xs break-words">vis-network integration pending. {nodes.length} actors/sectors/techniques loaded.</div>
        </div>
      </div>
    </div>
  );
