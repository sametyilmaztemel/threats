...
export default async function HomePage() {
  ...
  return (
    <div className="max-w-[1400px] mx-auto px-8 py-12">
      {/* Hero / Identity */}
      <section className="mb-24 mono-grid -mx-8 px-8 py-16 border-b border-line">
        ...
        <h1 className="text-[64px] leading-[0.9] font-extralight tracking-wider2 mb-6">
          CYBER THREAT<br />
      ...
      <section className="mb-20">
        <div className="flex justify-between items-end mb-4">
          <div>
            ...
            <h2 className="text-2xl font-light tracking-wider2">LIVE FEED <span className="terminal-cursor" /></h2>
          </div>
      ...
      <section>
        <div className="flex justify-between items-end mb-4">
          <div>
            ...
            <h2 className="text-2xl font-light tracking-wider2">SOURCES</h2>
          </div>
          <a href="/sources" className="text-[11px] tracking-widest2 text-dim hover:text-fg">[ ALL ]</a>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-px bg-line border border-line">
          {sources.map((s: any) => (
            <div key={s.id} className="bg-bg p-4 hover:bg-panel transition-colors">
